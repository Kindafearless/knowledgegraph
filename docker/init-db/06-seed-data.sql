...
INSERT INTO users (id, cognito_sub, email, name, password_hash, classification_level, organization, department, is_active) VALUES
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'admin@example.com', 'Admin User', '$2b$10$bExN.d7NKo6AYGZv5.UCU.2tqZ5s5jHji0tlQzoGUA08b1KYBDXh.', 'secret', 'Acme Corp', 'IT', true),
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'analyst@example.com', 'Data Analyst', '$2b$10$bExN.d7NKo6AYGZv5.UCU.2tqZ5s5jHji0tlQzoGUA08b1KYBDXh.', 'confidential', 'Acme Corp', 'Analytics', true),
    ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'cccccccc-cccc-cccc-cccc-cccccccccccc', 'viewer@example.com', 'Report Viewer', '$2b$10$bExN.d7NKo6AYGZv5.UCU.2tqZ5s5jHji0tlQzoGUA08b1KYBDXh.', 'unclassified', 'Acme Corp', 'Operations', true),
    ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'dddddddd-dddd-dddd-dddd-dddddddddddd', 'steward@example.com', 'Data Steward', '$2b$10$bExN.d7NKo6AYGZv5.UCU.2tqZ5s5jHji0tlQzoGUA08b1KYBDXh.', 'secret', 'Acme Corp', 'Data Governance', true)
